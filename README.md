...
- [Manjaro Linux](https://manjaro.org) - OS made by a (group of) French :fr::free:
- [Lubuntu](http://www.lubuntu.fr/) - OS made by a (group of) French :fr::free:
- [Mageia](https://www.mageia.org/) - OS made by a (group of) French :fr::free:
- [Emmabuntus](http://emmabuntus.sourceforge.net/) - OS made by a French organization (Emmaüs) :fr::free:
- [Lakka](http://www.lakka.tv/) - OS made by a (group of) French :fr::free:
- [PureOS](https://pureos.net) - OS made by a (group of) French :fr::free:
- [Toutou Linux](http://toutoulinux.free.fr/) - OS made by a (group of) French :fr::free:

## Software

- [VLC](http://www.videolan.org) - A media player :fr::free:[:octocat:](https://github.com/videolan)
- [Sielo](https://sielo.app) - Web Browser made with Qt and by a French :fr::free:[:octocat:](https://github.com/SieloBrowser/SieloBrowser)
